					...
					<NoSsr>
						...
						>
							...
							>
								...
								<Divider />
								{store.items.map((order: any, index: number) => {
									let flavors = '';
									order.Flavors.forEach((flav: any, indexx: number) => {
										flavors = flavors.concat(
											`${flav.Name}${
												(indexx >= order.Flavors.length - 1 && ' ') || ', '
											}`
										);
									});
									return (
					...
					>
						...
						>
							<Typography
								variant="h4"
								align="center"
								style={{ fontWeight: 600, marginBottom: 100, marginTop: 0 }}
							>
								Hookah To Go
							</Typography>

							{(isSmallScreen && <HookahToGoMobile />) || <HookahToGoWeb />}
						</Grid>
						...
						>
							<Typography
								variant="h4"
								align="center"
								style={{ fontWeight: 600, marginBottom: 100 }}
							>
								Previous Orders
							</Typography>

							{(isSmallScreen && <PreviousOrdersMobile />) || (
								<PreviousOrdersWeb />
							)}
						</Grid>
					</Grid>
